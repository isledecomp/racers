#ifndef GOLBDBBOUNDINGSHAPE_H
#define GOLBDBBOUNDINGSHAPE_H
...
public:
	...
	GolBdbBoundingShape();
	virtual ~GolBdbBoundingShape();                                        // vtable+0x00
	...
	// GolBdbBoundingShape::`vector deleting destructor'
