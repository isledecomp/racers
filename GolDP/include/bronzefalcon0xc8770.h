...
public:
	...
	void VTable0x34(LegoS32 p_unk0x04, const LegoFloat* p_unk0x08); // vtable+0x34
	void VTable0x38();                                              // vtable+0x38
	void VTable0x3c();                                              // vtable+0x3c
	void VTable0x40();                                              // vtable+0x40
	void VTable0x44();                                              // vtable+0x44
	void VTable0x48();                                              // vtable+0x48
	void VTable0x4c();                                              // vtable+0x4c
	void VTable0x50();                                              // vtable+0x50
	...
	void VTable0x88();                                              // vtable+0x88
	void VTable0x8c();                                              // vtable+0x8c
	void VTable0x90();                                              // vtable+0x90
	void VTable0x94();                                              // vtable+0x94
	void VTable0x98();                                              // vtable+0x98
	void VTable0x9c();                                              // vtable+0x9c
	void VTable0xa0();                                              // vtable+0xa0
	void VTable0xa4();                                              // vtable+0xa4
	void VTable0xa8();                                              // vtable+0xa8
	void VTable0xac();                                              // vtable+0xac
	void VTable0xb0();                                              // vtable+0xb0
