#ifndef GOLDIRECTDRAWPALETTE_H
#define GOLDIRECTDRAWPALETTE_H
...
// SIZE 0x0c
class GolDirectDrawPalette : public GolPaletteBase {
public:
	enum {
	...
	GolDirectDrawPalette();
	~GolDirectDrawPalette();

	void CreateDirectDrawPalette(class GolD3DRenderDevice* p_renderer, class GolSurfaceFormat* p_textureFormat);
	void Release();
