#ifndef GOLFDBFONTLIST_H
#define GOLFDBFONTLIST_H
...
// SIZE 0x28
class GolFdbFontList : public GolNameTable {
public:
	...
	GolFdbFontList();
	~GolFdbFontList() override; // vtable+0x00
	...
	// GolFdbFontList::`scalar deleting destructor'

	GolFdbFontList* GetNext() const { return m_next; }
	void SetNext(GolFdbFontList* p_next) { m_next = p_next; }
