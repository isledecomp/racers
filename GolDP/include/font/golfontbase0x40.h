...
public:
	...
	virtual void VTable0x00(const LegoChar* p_name, GolD3DRenderDevice* p_renderer);                // vtable+0x00
	...
	void FUN_1001eaa0(const LegoChar*, GolRenderDevice*, LegoS32, LegoS32, LegoFloat, LegoFloat, Rect*, undefined4);
	void FUN_1001df80(GolD3DRenderDevice* p_renderer, GolString* p_string, LegoU32 p_count);
	...
	LegoU32 FUN_1001e5e0(GolD3DRenderDevice* p_renderer, GolSurfaceFormat* p_textureFormat);
	LegoS32 FUN_1001eb70(GolString*, GolRenderDevice*, LegoS32, LegoS32, LegoFloat, LegoFloat, Rect*, undefined4);
	LegoS32 FUN_1001eca0(GolString*, GolRenderDevice*, LegoS32, LegoS32, LegoFloat, LegoFloat, Rect*, undefined4);
	void FUN_1001e970(GolString*, LegoS32*, LegoS32*);
	LegoS32 FUN_1001ed00(LegoU32, GolRenderDevice*, LegoS32, LegoS32, LegoFloat, LegoFloat, Rect*, undefined4);
	LegoBool32 FUN_1001ef60(GolRenderDevice*, Rect*, Rect*);
