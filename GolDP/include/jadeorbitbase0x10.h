...
public:
	...
	virtual void VTable0x18(
		FloatyVec0xc* p_unk0x04,
		FloatyVec0xc* p_unk0x08,
		FloatyVec0xc* p_unk0x0c
	) = 0;                                                                         // vtable+0x18
	virtual void VTable0x1c(FloatyVec0xc* p_unk0x04, FloatyVec0xc* p_unk0x08) = 0; // vtable+0x1c
	virtual void VTable0x20(FloatyVec0xc* p_unk0x04, FloatyVec0xc* p_unk0x08) = 0; // vtable+0x20
	...
	virtual void VTable0x30(FloatyVec0xc* p_unk0x04) = 0;                          // vtable+0x30
	virtual void VTable0x34(FloatyVec0xc* p_unk0x04) = 0;                          // vtable+0x34
	virtual void VTable0x38(FloatyVec0xc* p_unk0x04) = 0;                          // vtable+0x38
	virtual void VTable0x3c() = 0;                                                 // vtable+0x3c
	virtual void VTable0x40(FloatyVec0xc* p_unk0x04) = 0;                          // vtable+0x40
