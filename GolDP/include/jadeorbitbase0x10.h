...
public:
	...
	virtual void VTable0x18(GolVec3* p_unk0x04, GolVec3* p_unk0x08,
							GolVec3* p_unk0x0c) = 0;                     // vtable+0x18
	...
	virtual void VTable0x30(GolVec3* p_unk0x04) = 0;                     // vtable+0x30
	virtual void VTable0x34(GolVec3* p_unk0x04) = 0;                     // vtable+0x34
	virtual void VTable0x38(GolVec3* p_unk0x04) = 0;                     // vtable+0x38
	virtual void VTable0x3c() = 0;                                       // vtable+0x3c
	virtual void VTable0x40(GolVec3* p_unk0x04) = 0;                     // vtable+0x40
	virtual void VTable0x44(GolVec3* p_unk0x04) = 0;                     // vtable+0x44
