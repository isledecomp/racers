#ifndef GOLMDBMATERIALLIST_H
#define GOLMDBMATERIALLIST_H
...
// SIZE 0x1c
class GolMdbMaterialList : public GolNameTable {
public:
	// VTABLE: GOLDP 0x10057160
	// SIZE 0x1fc
	class MdbTxtParser : public GolTxtParser {
		// SYNTHETIC: GOLDP 0x10030050 FOLDED
		// GolMdbMaterialList::MdbTxtParser::`scalar deleting destructor'

		// SYNTHETIC: GOLDP 0x1001b000 FOLDED
		// GolMdbMaterialList::MdbTxtParser::~MdbTxtParser
	};

	GolMdbMaterialList();
	~GolMdbMaterialList() override; // vtable+0x00
	...
	// GolMdbMaterialList::`scalar deleting destructor'

	GolMdbMaterialList* GetNext() const { return m_next; }
	void SetNext(GolMdbMaterialList* p_next) { m_next = p_next; }
