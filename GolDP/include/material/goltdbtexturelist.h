#ifndef GOLTDBTEXTURELIST_H
#define GOLTDBTEXTURELIST_H
...
// SIZE 0x20
class GolTdbTextureList : public GolNameTable {
public:
	...
	class TdbTxtParser : public GolTxtParser {
		...
		// GolTdbTextureList::TdbTxtParser::`scalar deleting destructor'

		// SYNTHETIC: GOLDP 0x1001b000 FOLDED
		// GolTdbTextureList::TdbTxtParser::~TdbTxtParser
	};

	GolTdbTextureList();
	~GolTdbTextureList() override; // vtable+0x00
	...
	// GolTdbTextureList::`scalar deleting destructor'

	GolTdbTextureList* GetNext() const { return m_next; }
	void SetNext(GolTdbTextureList* p_next) { m_next = p_next; }
