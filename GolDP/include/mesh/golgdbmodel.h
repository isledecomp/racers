#ifndef GOLGDBMODEL_H
#define GOLGDBMODEL_H
...
// SIZE 0x48
class GolGdbModel : public GolGdbModelBase {
public:
	enum {
		e_vertexType1 = 1,
		e_vertexType2 = 2,
	...
	GolGdbModel();
	~GolGdbModel() override; // vtable+0x20
	...
	void FUN_10006c50(GolD3DRenderDevice* p_renderer, GolGdbMaterialList* p_materialTable);
	...
	// GolGdbModel::`vector deleting destructor'
