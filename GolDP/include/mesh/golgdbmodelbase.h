#ifndef GOLGDBMODELBASE_H
#define GOLGDBMODELBASE_H
...
public:
	...
	virtual ~GolGdbModelBase();                                                                        // vtable+0x20
	...
	GolGdbMaterialList* GetMaterialTable() { return &m_unk0x04; }
	...
	// GolGdbModelBase::`scalar deleting destructor'

protected:
	GolGdbMaterialList m_unk0x04;
