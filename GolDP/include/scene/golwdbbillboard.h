#ifndef GOLWDBBILLBOARD_H
#define GOLWDBBILLBOARD_H
...
// SIZE 0x4c
class GolWdbBillboard : public GolWdbEntity {
public:
	enum {
		c_flagBit1 = 1 << 1,
		c_flagBit2 = 1 << 2,
	...
	void VTable0x08(const GolVec3& p_v) override { GolWdbEntity::VTable0x08(p_v); } // vtable+0x08
