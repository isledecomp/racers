#ifndef GOLWDBMODELENTITY_H
#define GOLWDBMODELENTITY_H
...
// node/model-part tail starts in GolWdbSkinnedEntity here.
// VTABLE: GOLDP 0x10057270
// SIZE 0x90
class GolWdbModelEntity : public GolWdbOrientedEntity {
public:
	GolWdbModelEntity();
	...
	void FUN_10027c50(GolGdbModelBase* p_model, LegoFloat p_modelDistance);
