#ifndef GOLWDBSKINNEDENTITY_H
#define GOLWDBSKINNEDENTITY_H
...
// SIZE 0xf4
class GolWdbSkinnedEntity : public GolWdbModelEntity {
public:
	GolWdbSkinnedEntity();
	...
	void FUN_10023940(GolGdbModelBase*, GolSceneNode*, CmbModelPart0x34*, LegoFloat);
