...
private:
	...
	undefined m_unk0x4[0xb4 - 0x04]; // 0x04
	SmallCocoon0xc m_unk0xb4;        // 0xb4
	SmallCocoon0xc m_unk0xc0;        // 0xc0
	SmallCocoon0xc m_unk0xcc;        // 0xcc
	SmallCocoon0xc m_unk0xd8;        // 0xd8
	SmallCocoon0xc m_unk0xe4;        // 0xe4
};
