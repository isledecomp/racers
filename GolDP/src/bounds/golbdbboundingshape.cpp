...
DECOMP_SIZE_ASSERT(GolBdbBoundingShape::BdbTxtParser, 0x1fc)
DECOMP_SIZE_ASSERT(GolBdbBoundingShape::StructField0x08, 0x20)
DECOMP_SIZE_ASSERT(GolBdbBoundingShape::StructField0x18, 0x18)
DECOMP_SIZE_ASSERT(GolBdbBoundingShape, 0x2c)

// FUNCTION: GOLDP 0x1001adc0
GolBdbBoundingShape::GolBdbBoundingShape()
{
	m_unk0x04 = 0;
	m_unk0x08 = NULL;
	m_unk0x0c = NULL;
...
void GolBdbBoundingShape::Deserialize(const LegoChar* p_path, LegoBool32 p_binary)
{
	LegoS32 i;
...
void GolBdbBoundingShape::FUN_1001b010(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolBdbBoundingShape::FUN_1001b1a0(GolFileParser& p_parser)
{
	LegoS32 i;
...
void GolBdbBoundingShape::Destroy()
{
	m_unk0x04 = 0;
	m_unk0x10 = 0;
...
void GolBdbBoundingShape::FUN_1001b2c0(undefined4*, undefined4*, undefined4*)
{
	// TODO
	STUB(0x1001b2c0);
}
...
void GolBdbBoundingShape::FUN_1001b640(undefined4*, undefined4*, undefined4*, undefined4*)
{
	// TODO
	STUB(0x1001b640);
}
