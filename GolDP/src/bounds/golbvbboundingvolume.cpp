...
DECOMP_SIZE_ASSERT(GolBvbBoundingVolume, 0x64)
DECOMP_SIZE_ASSERT(GolBvbBoundingVolume::BvbTxtParser, 0x1fc)

// FUNCTION: GOLDP 0x1001b770
GolBvbBoundingVolume::GolBvbBoundingVolume() : m_unk0x24(&m_unk0x18)
{
	m_unk0x04 = 0;
	m_unk0x08 = NULL;
	m_unk0x0c = NULL;
...
GolBvbBoundingVolume::~GolBvbBoundingVolume()
{
	VTable0x08();
}

// FUNCTION: GOLDP 0x1001b800
void GolBvbBoundingVolume::VTable0x04(GolRenderDevice* p_renderer, const LegoChar* p_name, LegoBool32 p_binary)
{
	if (m_unk0x08 != NULL) {
		VTable0x08();
	}
...
void GolBvbBoundingVolume::VTable0x08()
{
	if (m_unk0x08 != NULL) {
		if (m_unk0x0c != NULL) {
...
void GolBvbBoundingVolume::FUN_1001bb10(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolBvbBoundingVolume::FUN_1001bbb0(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolBvbBoundingVolume::FUN_1001bd00(GolFileParser& p_parser)
{
	LegoU32 i;
...
undefined4 GolBvbBoundingVolume::FUN_1001be50()
{
