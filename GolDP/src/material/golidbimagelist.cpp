...
DECOMP_SIZE_ASSERT(GolIdbImageList, 0x1c)

// FUNCTION: GOLDP 0x10022fa0
GolIdbImageList::GolIdbImageList()
{
	m_renderer = NULL;
	m_next = NULL;
	m_numItems = 0;
...
void GolIdbImageList::LoadImageDefinitions(
...
void GolIdbImageList::VTable0x1c(GolD3DRenderDevice* p_renderer, LegoU32 p_numItems)
{
	if (m_numItems > 0) {
		Clear();
	}
...
void GolIdbImageList::VTable0x10()
{
	// empty
}

// FUNCTION: GOLDP 0x10029920 FOLDED
void GolIdbImageList::VTable0x14()
{
	// empty
}
