...
DECOMP_SIZE_ASSERT(GolMdbMaterialList, 0x1c)
DECOMP_SIZE_ASSERT(GolMdbMaterialList::MdbTxtParser, 0x1fc)

// FUNCTION: GOLDP 0x100261b0
GolMdbMaterialList::GolMdbMaterialList()
{
	m_renderer = NULL;
	m_next = NULL;
	m_unk0x14 = NULL;
...
void GolMdbMaterialList::VTable0x24(GolRenderDevice* p_renderer, const LegoChar* p_fileName, LegoBool32 p_binary)
{
	if (m_renderer != NULL) {
		Clear();
	}
...
void GolMdbMaterialList::FUN_10026970()
{
	LegoU32 i;
...
void GolMdbMaterialList::VTable0x20(
...
void GolMdbMaterialList::VTable0x1c(GolRenderDevice* p_renderer, LegoU32 p_capacity)
{
	if (m_renderer != NULL) {
		Clear();
	}
...
void GolMdbMaterialList::VTable0x0c()
{
	// empty
}

// FUNCTION: GOLDP 0x10029920 FOLDED
void GolMdbMaterialList::VTable0x10()
{
	// empty
}
