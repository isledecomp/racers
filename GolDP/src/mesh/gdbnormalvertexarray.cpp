...
void GdbNormalVertexArray::VTable0x08(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GdbNormalVertexArray::VTable0x04(LegoU16 p_count)
{
	LegoU32 i;
...
void GdbNormalVertexArray::VTable0x0c()
{
	if (m_unk0x1c != NULL) {
		delete[] m_unk0x1c;
		m_unk0x1c = NULL;
	...
	GdbColoredVertexArrayBase::VTable0x0c();
}

// FUNCTION: GOLDP 0x10006210 FOLDED
void GdbNormalVertexArray::VTable0x18(LegoU32 p_index, GolVec2* p_dest) const
{
...
void GdbNormalVertexArray::VTable0x1c(LegoU32 p_index, GolVec3* p_dest) const
{
...
void GdbNormalVertexArray::VTable0x20(LegoU32 p_index, ColorRGBA* p_dest) const
{
...
void GdbNormalVertexArray::VTable0x2c(LegoU32 p_index, const GolVec3& p_arg2)
{
...
void GdbNormalVertexArray::VTable0x28(LegoU32 p_index, const GolVec2& p_arg2)
{
...
void GdbNormalVertexArray::VTable0x30(LegoU32 p_index, const ColorRGBA& p_arg2)
{
