...
DECOMP_SIZE_ASSERT(GolGdbModel, 0x48)

// FUNCTION: GOLDP 0x10006840
GolGdbModel::GolGdbModel()
{
	m_unk0x40 = NULL;
}
...
void GolGdbModel::VTable0x1c(GolRenderDevice* p_renderer, const LegoChar* p_name, LegoBool32 p_binary)
{
	if (m_unk0x24) {
		VTable0x24();
	}

	GolGdbModelBase::VTable0x1c(p_renderer, p_name, p_binary);
...
void GolGdbModel::VTable0x24()
{
	...
	GolGdbModelBase::VTable0x24();
}

// FUNCTION: GOLDP 0x10006aa0
void GolGdbModel::VTable0x0c(GolFileParser& p_parser)
{
	if (m_unk0x40 != NULL) {
...
void GolGdbModel::VTable0x10(GolFileParser& p_parser)
{
	if (m_unk0x40 != NULL) {
		p_parser.HandleUnexpectedToken(GolFileParser::e_unsuportedKeyword);
	}
...
void GolGdbModel::VTable0x14(GolFileParser& p_parser)
{
	if (m_unk0x40 != NULL) {
		p_parser.HandleUnexpectedToken(GolFileParser::e_unsuportedKeyword);
	}
...
void GolGdbModel::FUN_10006c50(GolD3DRenderDevice* p_renderer, GolGdbMaterialList* p_materialTable)
{
...
LegoU32 GolGdbModel::FUN_10006fa0(LegoU32 p_firstTriangle, LegoU32 p_triangleCount) const
{
