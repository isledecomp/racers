...
DECOMP_SIZE_ASSERT(GolGdbModelBase, 0x40)
DECOMP_SIZE_ASSERT(GolGdbModelBase::GdbTxtParser, 0x1fc)

// FUNCTION: GOLDP 0x10027020
GolGdbModelBase::GolGdbModelBase()
{
	m_unk0x10 = NULL;
	m_unk0x14 = NULL;
	m_unk0x18 = NULL;
...
void GolGdbModelBase::VTable0x1c(GolRenderDevice* p_renderer, const LegoChar* p_name, LegoBool32 p_binary)
{
	if (m_unk0x24 != NULL) {
		VTable0x24();
	}
...
void GolGdbModelBase::FUN_100272e0(LegoU32 p_countVertices, LegoU32 p_countGroups)
{
...
void GolGdbModelBase::VTable0x24()
{
	if (m_unk0x14 != NULL) {
...
void GolGdbModelBase::VTable0x00(GolFileParser& p_parser)
{
...
void GolGdbModelBase::VTable0x04(GolFileParser& p_parser)
{
	if (m_unk0x18 != NULL) {
		p_parser.HandleUnexpectedToken(GolFileParser::e_unsuportedKeyword);
	}
...
void GolGdbModelBase::VTable0x28(GdbVertexArray0xc** p_dest) const
{
	*p_dest = m_unk0x10;
}

// FUNCTION: GOLDP 0x100277e0
void GolGdbModelBase::VTable0x2c(LegoU32 p_arg1, LegoBool32 p_arg2)
{
	m_unk0x3c |= p_arg1;
	if (p_arg2) {
		VTable0x38(&m_unk0x28, &m_unk0x34, m_unk0x38);
...
void GolGdbModelBase::VTable0x30(IGdbModelIndexArray0x8** p_dest) const
{
	*p_dest = m_unk0x18;
}

// FUNCTION: GOLDP 0x10027820
void GolGdbModelBase::VTable0x34(LegoU32 p_arg1)
{
	m_unk0x3c |= p_arg1;
}

// FUNCTION: GOLDP 0x10027830
void GolGdbModelBase::VTable0x08(GolFileParser& p_parser)
{
	if (m_unk0x14 != NULL) {
		p_parser.HandleUnexpectedToken(GolFileParser::e_unsuportedKeyword);
	}
...
void GolGdbModelBase::VTable0x14(GolFileParser& p_parser)
{
	// empty
}

// FUNCTION: GOLDP 0x100278c0
void GolGdbModelBase::VTable0x38(GolVec3* p_center, LegoFloat* p_radius, LegoFloat p_scale) const
{
	LegoU32 countGroups;
	GolVec3 vertex;
	GolVec3 max;
...
void GolGdbModelBase::VTable0x3c(const ColorTransform0x20& p_details)
{
	m_unk0x10->VTable0x34(p_details);
}

// FUNCTION: GOLDP 0x10027b40
void GolGdbModelBase::VTable0x40()
{
