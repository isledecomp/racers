...
DECOMP_SIZE_ASSERT(GolWdbBillboard, 0x4c)
DECOMP_SIZE_ASSERT(GolWdbBillboard::Field0x2c, 0x0c)

// GLOBAL: GOLDP 0x100574fc
float g_pontoonMaxFloat = FLT_MAX;

// FUNCTION: GOLDP 0x10029df0
GolWdbBillboard::GolWdbBillboard()
{
	m_position = NULL;
...
void GolWdbBillboard::VTable0x4c(
...
void GolWdbBillboard::FUN_10029e90(
...
void GolWdbBillboard::VTable0x50()
{
	m_position = NULL;
	m_flags = 0;
	m_width = 0;
...
void GolWdbBillboard::VTable0x14(const GolViewFrustum& p_view, ResultStruct* p_result)
{
	GolVec3 position;
...
void GolWdbBillboard::FUN_10026fa0(LegoFloat p_scalar)
{
	m_radius = p_scalar;
...
void GolWdbBillboard::FUN_10029fa0(const GolVec3& p_arg1, LegoBool32* p_result)
{
	GolVec3 position;
...
undefined4* GolWdbBillboard::FUN_1002a020()
{
...
void GolWdbBillboard::VTable0x1c(GolRenderDevice& p_renderer)
{
	p_renderer.VTable0xb4(*this);
}

// FUNCTION: GOLDP 0x1002a060
LegoBool32 GolWdbBillboard::VTable0x20()
{
	if (m_flags & c_flagBit2) {
		m_position = m_positionContainer->GetPosition(m_positionIndex);
	}
