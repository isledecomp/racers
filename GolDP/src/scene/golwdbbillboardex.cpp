...
LegoBool32 GolWdbBillboard::FUN_10014e50(const GolVec3* p_arg1, const GolVec3* p_arg2, GolMatrix4* p_matrix)
{
	GolVec3 row0;
	GolVec3 row1;
	GolVec3 position;
...
void GolWdbBillboardEx::VTable0x4c(
...
{
	GolWdbBillboard::VTable0x4c(p_position, p_width, p_height, p_maxDistanceSquared);
}

// STUB: GOLDP 0x10014ff0
void GolWdbBillboard::FUN_10014ff0(GolD3DRenderDevice*)
{
	// TODO
	STUB(0x10014ff0);
}
