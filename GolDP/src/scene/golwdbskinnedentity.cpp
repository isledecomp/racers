...
void GolWdbSkinnedEntity::FUN_10023490(
...
void GolWdbSkinnedEntity::FUN_100234c0(GolSceneNode* p_node, CmbModelPart0x34* p_modelParts, LegoFloat p_modelDistance)
{
...
void GolWdbSkinnedEntity::VTable0x54()
{
	LegoU32 i;
...
void GolWdbSkinnedEntity::VTable0x5c(LegoU32)
{
	STUB(0x10023580);
}

// FUNCTION: GOLDP 0x10023940
void GolWdbSkinnedEntity::FUN_10023940(
	GolGdbModelBase* p_model,
	GolSceneNode* p_node,
	CmbModelPart0x34* p_modelParts,
	LegoFloat p_modelDistance
...
void GolWdbSkinnedEntity::FUN_100239e0(GolSceneNode* p_node, CmbModelPart0x34* p_modelParts, LegoFloat p_modelDistance)
{
	LegoU32 i;
...
void GolWdbSkinnedEntity::FUN_10023a70(LegoU32 p_partIndex)
{
	LegoS32 noPart = -1;
...
void GolWdbSkinnedEntity::VTable0x10(LegoS32)
{
	STUB(0x10023b10);
}

// STUB: GOLDP 0x10023ef0
void GolWdbSkinnedEntity::VTable0x4c(LegoU32 p_index)
{
	STUB(0x10023ef0);
...
void GolWdbSkinnedEntity::VTable0x14(const GolViewFrustum& p_view, ResultStruct* p_result)
{
	LegoU32 i;
	LegoFloat* threshold;
	GolVec3 position;
...
GolSceneNode* GolWdbSkinnedEntity::VTable0x58(LegoU32 p_arg1)
{
