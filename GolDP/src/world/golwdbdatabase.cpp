...
#include "bounds/golbvbboundingvolume.h"
...
DECOMP_SIZE_ASSERT(GolWdbDatabase, 0xf0)
DECOMP_SIZE_ASSERT(GolWdbDatabase::WdbTxtParser, 0x1fc)
...
GolWdbDatabase::GolWdbDatabase()
{
	Reset();
}

// FUNCTION: GOLDP 0x1002c0e0
void GolWdbDatabase::Reset()
{
	m_unk0x94 = 1.0f;
	m_unk0x04 = 0;
	m_unk0x0c = 0;
...
void GolWdbDatabase::VTable0x14(GolRenderDevice* p_arg1, const LegoChar* p_name, LegoBool32 p_binary, LegoFloat p_arg4)
{
	if (m_unk0x04) {
		VTable0x18();
	}
...
void GolWdbDatabase::VTable0x00()
{
	if (m_unk0x90 != NULL) {
		delete[] m_unk0x90;
		m_unk0x90 = NULL;
...
void GolWdbDatabase::VTable0x18()
{
	VTable0x00();
...
void GolWdbDatabase::FUN_1002c7b0(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002c840(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002c8d0(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002c960(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002c9f0(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002ca80(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002cb10(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002cba0(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002cc30(GolFileParser& p_parser)
{
	LegoU32 i;
	LegoS32 v;
...
void GolWdbDatabase::FUN_1002cfa0(GolFileParser& p_parser)
{
	LegoU32 i;
	LegoS32 v;
...
void GolWdbDatabase::FUN_1002d400(GolFileParser& p_parser)
{
	LegoU32 i;
	LegoS32 v;
...
void GolWdbDatabase::FUN_1002d720(GolFileParser& p_parser)
{
	LegoU32 i;
	LegoS32 v;
...
void GolWdbDatabase::FUN_1002d950(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002db50(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002dbe0(GolFileParser& p_parser, Rect** p_rects, LegoU32* p_count)
{
	LegoU32 i;
	LegoU32 count;
	Rect* rects;
...
void GolWdbDatabase::FUN_1002dc80(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002df90(GolFileParser& p_parser)
{
	LegoU32 i;
...
void GolWdbDatabase::FUN_1002e0d0(GolFileParser& p_parser)
{
	LegoU32 i;
	if (m_unk0x90 != NULL) {
		p_parser.HandleUnexpectedToken(GolFileParser::e_unsuportedKeyword);
...
void GolWdbDatabase::FUN_1002e250(GolWdbBillboard* p_billboard, WdbBillboardSprite0x38* p_sprite)
{
	if (p_sprite->m_unk0x32 == 0) {
		return;
	}

	if (!(p_billboard->GetFlags() & GolWdbBillboard::c_flagBit2)) {
...
void GolWdbDatabase::VTable0x04()
{
	if (m_unk0x44 != 0) {
		m_unk0x98 = new GolBvbBoundingVolume[m_unk0x44];
		if (m_unk0x98 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (m_unk0x4c != 0) {
		m_unk0x9c = new GolWdbModelEntity[m_unk0x4c];
		if (m_unk0x9c == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (m_unk0x54 != 0) {
		m_unk0xa0 = new GolWdbSkinnedEntity[m_unk0x54];
		if (m_unk0xa0 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (m_unk0x5c != 0) {
		m_unk0xa4 = new GolWdbCollidableEntity[m_unk0x5c];
		if (m_unk0xa4 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (m_unk0x64 != 0) {
		m_unk0xa8 = new GolWdbBoundedEntity[m_unk0x64];
		if (m_unk0xa8 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
...
void GolWdbDatabase::FUN_1002e640()
{
	LegoU32 i;
	LegoU32 j;
	LegoU32 lod;
	...
	for (i = 0; i < m_unk0x4c; i++) {
		...
		GolWdbModelEntity* runtime = &m_unk0x9c[i];
		...
		if (model->m_flags & WdbModel0x8c::e_flagBit1) {
			runtime->m_flags |= GolWdbModelEntity::c_flagBit1;
		}
		if (model->m_flags & WdbModel0x8c::e_flagBit2) {
			runtime->m_flags |= GolWdbModelEntity::c_flagBit2;
		}
	...
	for (i = 0; i < m_unk0x54; i++) {
		...
		GolWdbSkinnedEntity* runtime = &m_unk0xa0[i];
	...
	for (i = 0; i < m_unk0x5c; i++) {
		...
		GolWdbCollidableEntity* runtime = &m_unk0xa4[i];
	...
	for (i = 0; i < m_unk0x64; i++) {
		...
		GolWdbBoundedEntity* runtime = &m_unk0xa8[i];
...
void GolWdbDatabase::FUN_1002f210(LegoU32 p_cameraIndex, GolCameraBase* p_lens)
{
	...
	if (camera->m_unk0x08 >= 0) {
		GolWdbSkinnedEntity* model = &m_unk0xa0[camera->m_unk0x08];
...
void GolWdbDatabase::VTable0x54(undefined4 p_arg)
{
	FUN_1002baf0(p_arg);
}
