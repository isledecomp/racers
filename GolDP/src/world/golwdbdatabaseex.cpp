...
DECOMP_SIZE_ASSERT(GolWdbDatabaseEx, 0x118)
...
GolWdbDatabaseEx::GolWdbDatabaseEx()
{
	m_unk0xf0 = NULL;
	m_unk0xf4 = NULL;
	m_unk0x10c = NULL;
...
GolTdbTextureList* GolWdbDatabaseEx::VTable0x2c(LegoU32 p_index) const
{
	return &m_unk0xf0[p_index];
}

// FUNCTION: GOLDP 0x10017270
GolMdbMaterialList* GolWdbDatabaseEx::VTable0x30(LegoU32 p_index) const
{
	return &m_unk0xf4[p_index];
}

// FUNCTION: GOLDP 0x10017290
CmbModelPart0x34* GolWdbDatabaseEx::VTable0x34(LegoU32 p_index) const
{
	return &m_unk0x10c[p_index];
}

// FUNCTION: GOLDP 0x100172b0
GolGdbModelBase* GolWdbDatabaseEx::VTable0x38(LegoU32 p_index) const
{
	return &m_unk0xf8[p_index];
}

// FUNCTION: GOLDP 0x100172d0
GolGdbMaterialList* GolWdbDatabaseEx::VTable0x3c(LegoU32 p_index) const
{
	return &m_unk0x104[p_index];
}

// FUNCTION: GOLDP 0x100172f0
GolSceneNode* GolWdbDatabaseEx::VTable0x40(LegoU32 p_index) const
{
	return &m_unk0xfc[p_index];
}

// FUNCTION: GOLDP 0x10017310
GolBdbBoundingShape* GolWdbDatabaseEx::VTable0x44(LegoU32 p_index) const
{
	return &m_unk0x110[p_index];
}

// FUNCTION: GOLDP 0x10017330
GolWdbEntity* GolWdbDatabaseEx::VTable0x48(LegoU32 p_index) const
{
	return &m_unk0x100[p_index];
}

// FUNCTION: GOLDP 0x10017350
MabMaterialAnimation0x14* GolWdbDatabaseEx::VTable0x4c(LegoU32 p_index) const
{
	return &m_unk0x108[p_index];
}

// FUNCTION: GOLDP 0x10017370
GolCameraBase* GolWdbDatabaseEx::VTable0x50(LegoU32 p_index) const
{
	return &m_unk0x114[p_index];
}

// FUNCTION: GOLDP 0x10017390
void GolWdbDatabaseEx::VTable0x08()
{
	if (GetUnk0x0c() != 0) {
	...
	if (GetUnk0x24() != 0) {
		m_unk0xf8 = new GolGdbModel[GetUnk0x24()];
		if (m_unk0xf8 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (GetUnk0x2c() != 0) {
		m_unk0x104 = new GolGdbMaterialList[GetUnk0x2c()];
		if (m_unk0x104 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (GetUnk0x3c() != 0) {
		m_unk0x110 = new GolBdbBoundingShape[GetUnk0x3c()];
		if (m_unk0x110 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
	...
	if (GetUnk0x6c() != 0) {
		m_unk0x100 = new GolWdbBillboardEx[GetUnk0x6c()];
		if (m_unk0x100 == NULL) {
			GOL_FATALERROR(c_golErrorOutOfMemory);
		}
	}
...
undefined4* GolWdbDatabaseEx::VTable0x0c()
{
	STUB(0x10017ac0);
...
void GolWdbDatabaseEx::VTable0x18()
{
	if (m_unk0x114) {
		delete[] m_unk0x114;
		m_unk0x114 = NULL;
	...
	GolWdbDatabase::VTable0x18();
}

// STUB: GOLDP 0x100181b0
void GolWdbDatabaseEx::VTable0x1c(GolRenderDevice*)
{
	STUB(0x100181b0);
}

// STUB: GOLDP 0x100181f0
void GolWdbDatabaseEx::VTable0x20(GolRenderDevice*)
{
	STUB(0x100181f0);
}

// STUB: GOLDP 0x10018230
void GolWdbDatabaseEx::VTable0x24(GolRenderDevice*)
{
	STUB(0x10018230);
}

// STUB: GOLDP 0x10018270
void GolWdbDatabaseEx::VTable0x28(GolRenderDevice*)
{
	STUB(0x10018270);
}
