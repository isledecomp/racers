...
public:
	...
	JoystickDevice* GetJoystick(LegoS32 p_index) const { return m_joysticks[p_index]; }
	JoystickDevice* FindJoystickByDeviceId(LegoS32 p_deviceId) const;
...
protected:
	...
	KeyboardDevice* m_keyboard;          // 0x9c
	MouseDevice* m_mouse;                // 0xa0

protected:
	JoystickDevice* m_joysticks[16];  // 0xa4
