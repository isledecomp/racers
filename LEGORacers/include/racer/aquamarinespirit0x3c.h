...
public:
	...
	LegoU32 FUN_0041e330(const LegoChar* p_name, AnimatedModelEntity** p_primary, AnimatedModelEntity** p_secondary);
	void FUN_0041e570();
	AnimatedModelEntity* FUN_0041e5b0(const LegoChar* p_name);
	...
	struct Item0x104 {
		...
		AnimatedModelEntity* m_primaryModel;   // 0x0f8
		AnimatedModelEntity* m_secondaryModel; // 0x0fc
...
private:
	...
	LegoU32 FUN_0041e360(Item0x104* p_item, AnimatedModelEntity** p_primary, AnimatedModelEntity** p_secondary);
	...
	AnimatedModelEntity* m_unk0x2c; // 0x2c
