...
public:
	...
	GolGdbModelBase* FUN_0049db90(TurquoiseGlowColor* p_color, GolGdbModelBase* p_model, undefined4 p_unk0x0c);
	GolSceneNode* FUN_0049dc10(TurquoiseGlowColor* p_color);
	void FUN_0049dc90(undefined4* p_dest);
	void FUN_0049dce0(GolGdbModelBase* p_model, TurquoiseGlowColor* p_color);
...
private:
	...
	void FUN_0049d570(GolGdbModelBase* p_model, ModelSummary0x14* p_summary);
	LegoBool32 FUN_0049d5c0() const;
	void FUN_0049d600();
	LegoBool32 FUN_0049d670(GolGdbModelBase* p_model) const;
	GolGdbModelBase* FUN_0049d6e0(undefined2 p_vertexType);
	void CopyModelVertices(GolGdbModelBase* p_sourceModel, GolGdbModelBase* p_destModel, LegoU32 p_vertexOffset);
	void FUN_0049d880(GolGdbModelBase* p_sourceModel, GolGdbModelBase* p_destModel, LegoU32 p_indexOffset);
	void FUN_0049d920();
	void FUN_0049d970();
	void FUN_0049d9b0(DuskwindBananaRelic0x24* p_material, const LegoChar* p_name);
	GolGdbModelBase* FUN_0049dab0(TurquoiseGlowColor* p_color, GolGdbModelBase* p_model, undefined4 p_unk0x0c);
	void FUN_0049dd50();
	...
	GolTdbTextureList* m_menuResource0;  // 0x1c
	GolMdbMaterialList* m_menuResource1; // 0x20
