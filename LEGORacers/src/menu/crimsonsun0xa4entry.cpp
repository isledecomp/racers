...
{
	FUN_0046c050(&m_unk0x2cc, 0x11f, 0x47);
...
MenuInputBindingTable* CrimsonSun0xa4::Entry0x74c::GetMenuInputBindings()
{
...
undefined4 CrimsonSun0xa4::Entry0x74c::VTable0x18(ObscureVantage0x58*, InputEventQueue::Item*, undefined4, undefined4)
{
	return m_unk0x2bc != 2;
}

// FUNCTION: LEGORACERS 0x00468820 FOLDED
undefined4 CrimsonSun0xa4::Entry0x74c::VTable0x1c(ObscureVantage0x58*, InputEventQueue::Item*, undefined4, undefined4)
{
	return m_unk0x2bc != 2;
}
