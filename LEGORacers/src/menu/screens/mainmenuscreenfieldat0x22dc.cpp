...
DECOMP_SIZE_ASSERT(MainMenuScreenFieldAt0x22dc, 0x15c)
DECOMP_SIZE_ASSERT(MainMenuScreenFieldAt0x22dc::CreateParams, 0x1c)

// GLOBAL: LEGORACERS 0x004b33c4
LegoFloat g_fltMax0x004b33c4 = FLT_MAX;

// FUNCTION: LEGORACERS 0x0047de70
MainMenuScreenFieldAt0x22dc::MainMenuScreenFieldAt0x22dc()
{
	Reset();
}
...
void MainMenuScreenFieldAt0x22dc::Reset()
{
...
void MainMenuScreenFieldAt0x22dc::FUN_0047df90()
{
	...
	undefined4 zero = 0;
	GolGdbModelBase* nullModel = NULL;
...
LegoBool32 MainMenuScreenFieldAt0x22dc::FUN_0047e0a0(CreateParams* p_createParams)
{
	VTable0x08();
...
LegoBool32 MainMenuScreenFieldAt0x22dc::VTable0x08()
{
	if (!m_unk0x18) {
		return TRUE;
	}
...
void MainMenuScreenFieldAt0x22dc::FUN_0047e130(LegoU8 p_unk0x04)
{
...
void MainMenuScreenFieldAt0x22dc::FUN_0047e160(LegoU8 p_unk0x04, LegoU8 p_unk0x08)
{
	m_unk0x154.m_unk0x01 = p_unk0x04;
	m_unk0x154.m_unk0x04 = p_unk0x08;
	GolGdbModelBase* model = m_unk0x150->FUN_0049db90(&m_unk0x154, m_unk0x110, 0);
	m_unk0x150->FUN_0049dce0(model, &m_unk0x154);
}

// FUNCTION: LEGORACERS 0x0047e1b0
void MainMenuScreenFieldAt0x22dc::FUN_0047e1b0(LegoU8 p_unk0x04)
{
...
void MainMenuScreenFieldAt0x22dc::FUN_0047e1e0(LegoU8 p_unk0x04)
{
...
void MainMenuScreenFieldAt0x22dc::FUN_0047e210(TurquoiseGlowColor* p_color)
{
	m_unk0x154 = *p_color;
	m_unk0x150->FUN_0049db90(&m_unk0x154, m_unk0x110, 0);
}
...
LegoBool32 MainMenuScreenFieldAt0x22dc::VTable0x0c()
{
	GolVec3 position;
...
LegoBool32 MainMenuScreenFieldAt0x22dc::VTable0x10(undefined4 p_unk0x04)
{
