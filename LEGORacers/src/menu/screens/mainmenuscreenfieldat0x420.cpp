...
DECOMP_SIZE_ASSERT(MainMenuScreenFieldAt0x420::CreateParams0x48, 0x48)

// FUNCTION: LEGORACERS 0x0046f410
MainMenuScreenFieldAt0x420::MainMenuScreenFieldAt0x420()
{
	Reset();
}
...
void MainMenuScreenFieldAt0x420::Reset()
{
	m_unk0x64.Reset();
	m_unk0x5c = 0;
	m_unk0x60 = NULL;
...
LegoBool32 MainMenuScreenFieldAt0x420::FUN_0046f520(
...
void MainMenuScreenFieldAt0x420::VTable0x44(undefined2 p_unk0x04, undefined4 p_unk0x08)
{
	GolString string;
...
void MainMenuScreenFieldAt0x420::VTable0x40(GolString* p_string, undefined4 p_unk0x08)
{
...
void MainMenuScreenFieldAt0x420::FUN_0046f6b0(LegoS32 p_rightMargin)
{
	LegoS32 right;
	LegoS32 left;
