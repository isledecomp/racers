...
DECOMP_SIZE_ASSERT(OptionsScreenFieldAt0x4178Base0x6e4, 0x6e4)
DECOMP_SIZE_ASSERT(OptionsScreenFieldAt0x4178, 0x6ec)

// FUNCTION: LEGORACERS 0x004113b0 FOLDED
undefined4 OptionsScreenFieldAt0x4178Base0x6e4::VTable0x3c(undefined4)
{
	return NULL;
}

// FUNCTION: LEGORACERS 0x0046de60
OptionsScreenFieldAt0x4178Base0x6e4::OptionsScreenFieldAt0x4178Base0x6e4()
{
	Reset();
}
...
void OptionsScreenFieldAt0x4178Base0x6e4::Reset()
{
	m_unk0x6c0 = 0;
	m_unk0x6c8 = 0;
	m_unk0x6c4 = 0;
...
LegoBool32 OptionsScreenFieldAt0x4178Base0x6e4::FUN_0046dfb0(
...
)
{
	...
	ObscureIcon0x1a8::SoundIdPair0x4* soundIds = &p_createParams->m_unk0xac;
...
void OptionsScreenFieldAt0x4178Base0x6e4::VTable0x14(VisualState0x4* p_visualState)
{
...
void OptionsScreenFieldAt0x4178Base0x6e4::VTable0x78()
{
	if (m_unk0x6c0) {
...
void OptionsScreenFieldAt0x4178Base0x6e4::VTable0x7c()
{
...
undefined4 OptionsScreenFieldAt0x4178Base0x6e4::VTable0x74(undefined4 p_event)
{
...
ObscureVantage0x58* OptionsScreenFieldAt0x4178Base0x6e4::VTable0x30(
	...
	if ((stateFlags & c_flagBit0) && (!m_activeKeyCode || m_activeKeyCode == keyCode) &&
		...
		if ((stateFlags & c_flagBit0) && (stateFlags & c_flagBit1)) {
			if ((result & InputDevice::c_sourceMask) == InputDevice::c_sourceMouse) {
				undefined4 x = p_x;
				undefined4 y = p_y;
				m_unk0x5ec.FUN_004731b0(x, y);

				if (m_unk0x5ec.FUN_00472c40(x, y)) {
...
ObscureVantage0x58* OptionsScreenFieldAt0x4178Base0x6e4::VTable0x34(
	InputEventQueue::Event* p_event,
	undefined4 p_x,
	undefined4 p_y
)
...
void OptionsScreenFieldAt0x4178::FUN_0046e4b0()
{
...
undefined4 OptionsScreenFieldAt0x4178::VTable0x70(undefined4 p_event, undefined4 p_x, undefined4 p_y)
{
	if ((p_event & InputDevice::c_sourceMask) == InputDevice::c_sourceMouse) {
		undefined4 x = p_x;
		undefined4 y = p_y;
		...
		if (!(m_stateFlags & c_flagBit2) && m_unk0x5ec.FUN_00472c40(x, y)) {
			return p_event;
		}

		return ObscureBanner0x5ec::VTable0x70(p_event, p_x, p_y);
	}
...
ObscureVantage0x58* OptionsScreenFieldAt0x4178::VTable0x2c(void* p_item, undefined4 p_x, undefined4 p_y)
{
	ObscureIcon0x1a8::VTable0x2c(p_item, p_x, p_y);
