...
void RaceSession::Field0x6dc::Field0xa8::FUN_00430d40(Params* p_params)
{
...
void RaceSession::Field0x6dc::Field0xa8::VTable0x0c(
	Params* p_params,
...
void RaceSession::Field0x6dc::Field0xa8::VTable0x08(
	Params* p_params,
	RaceState::Racer* p_racer,
	GolVec3* p_unk0x0c,
	GolVec3* p_unk0x10,
...
void RaceSession::Field0x6dc::Field0xa8::VTable0x04(Params* p_params, GolVec3* p_unk0x08)
{
...
void RaceSession::Field0x6dc::Field0xa8::FUN_004314d0(LegoEventQueue* p_eventQueue)
{
	if (m_unk0x044 != NULL) {
...
LegoS32 RaceSession::Field0x6dc::Field0xa8::VTable0x18(LegoU32 p_elapsedMs)
{
...
void RaceSession::Field0x6dc::Field0xa8::VTable0x00(LegoEventQueue::CallbackData* p_data)
{
