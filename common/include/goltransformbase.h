...
public:
	...
	virtual void VTable0x1c(GolVec3* p_child, GolVec3* p_unk0x08) = 0; // vtable+0x1c
	virtual void VTable0x20(GolVec3* p_child, GolVec3* p_unk0x08) = 0; // vtable+0x20
	virtual void VTable0x24(GolVec3* p_child, GolVec3* p_unk0x08) = 0; // vtable+0x24
	virtual void VTable0x28(GolVec3* p_child, GolVec3* p_unk0x08) = 0; // vtable+0x28
	virtual void VTable0x2c(LegoFloat* p_child) = 0;                   // vtable+0x2c
	...
	virtual void VTable0x48(GolTransformBase* p_source) = 0;           // vtable+0x48
