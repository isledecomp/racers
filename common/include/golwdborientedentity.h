#ifndef GOLWDBORIENTEDENTITY_H
#define GOLWDBORIENTEDENTITY_H
...
// SIZE 0x58
class GolWdbOrientedEntity : public GolWdbEntity {
public:
	GolWdbOrientedEntity();
