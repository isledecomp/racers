#ifndef JAMFILESYSTEM_H
#define JAMFILESYSTEM_H
...
public:
	...
	virtual LegoS32 ReadLine(
		LegoU32 p_offset, void* p_buf,
		LegoU32 p_size,
		LegoU32 p_maxSize,
		LegoS32* p_lenRead
	);                                                                                              // vtable+0x08
	virtual LegoS32 ReadRaw(LegoU32 p_offset, void* p_buf, LegoU32 p_size, LegoS32* p_lenRead); // vtable+0x0c
	virtual ~JamFileSystem();                                                                       // vtable+0x10
...
private:
	...
	JamDirectory m_rootDir;               // 0x0c
	JamDirectory::JamFile* m_foundFile;   // 0x30
};

#endif // JAMFILESYSTEM_H
