...
void GolWdbOrientedEntity::VTable0x48(GolVec3* p_dest1, GolVec3* p_dest2) const
{
...
GolWdbOrientedEntity::GolWdbOrientedEntity()
{
	Reset();
}
...
void GolWdbOrientedEntity::Reset()
{
	m_velocity.m_x = 0.0f;
	m_velocity.m_y = 0.0f;
	m_velocity.m_z = 0.0f;
...
void GolWdbOrientedEntity::VTable0x40(const GolVec3& p_v1, const GolVec3& p_v2)
{
	GolVec3 unit;
...
void GolWdbOrientedEntity::FUN_10026c50(GolMatrix4* p_dest)
{
...
void GolWdbOrientedEntity::VTable0x44(GolMatrix3* p_dest) const
{
	p_dest->m_m[0][0] = m_orientation.m_m[0][0];
	p_dest->m_m[0][1] = m_orientation.m_m[0][1];
	p_dest->m_m[0][2] = m_orientation.m_m[0][2];
...
void GolWdbOrientedEntity::VTable0x3c(const GolMatrix34& p_matrix)
{
...
void GolWdbOrientedEntity::VTable0x34(const GolVec3& p_src, GolVec3* p_dest)
{
...
void GolWdbOrientedEntity::VTable0x38(const GolVec3& p_src, GolVec3* p_dest) const
{
	p_dest->m_x = m_orientation.m_m[0][0] * p_src.m_x;
...
void GolWdbOrientedEntity::VTable0x2c(const GolVec3& p_src, GolVec3* p_dest) const
{
	p_dest->m_x = m_orientation.m_m[0][0] * p_src.m_x;
	p_dest->m_y = m_orientation.m_m[0][1] * p_src.m_x;
	p_dest->m_z = m_orientation.m_m[0][2] * p_src.m_x;
...
void GolWdbOrientedEntity::VTable0x30(const GolVec3& p_src, GolVec3* p_dest) const
{
...
void GolWdbOrientedEntity::VTable0x04(GolVec3* p_dest) const
{
	p_dest->m_x = m_position.m_x;
	p_dest->m_y = m_position.m_y;
	p_dest->m_z = m_position.m_z;
...
void GolWdbOrientedEntity::VTable0x08(const GolVec3& p_pos)
{
...
void GolWdbOrientedEntity::FUN_10026f70(const GolVec3& p_v)
{
	m_center = p_v;
...
void GolWdbOrientedEntity::FUN_10026fa0(LegoFloat p_scalar)
{
	m_radius = p_scalar;
...
void GolWdbOrientedEntity::FUN_10026fc0(GolMatrix4* p_dest, LegoFloat p_scale) const
{
